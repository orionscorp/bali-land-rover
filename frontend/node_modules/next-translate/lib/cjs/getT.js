...
function getT(locale, namespace) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var appDir, config, defaultLoader, lang, loader, namespaces, allNamespaces, localesToIgnore, ignoreLang, pluralRules, t, defaultNamespace;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    loader = config.loadLocaleFrom || defaultLoader;
                    namespaces = Array.isArray(namespace) ? namespace : [namespace];
                    allNamespaces = {};
                    return [4, Promise.all(namespaces.map(function (namespace) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        _a = allNamespaces;
                                        _b = namespace;
                                        return [4, loader(lang, namespace)];
                                    case 1:
                                        _a[_b] = _c.sent();
                                        return [2];
                                }
